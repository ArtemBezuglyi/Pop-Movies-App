...
import ru.artbez.moviepop.screens.en1.En1Fragment

class En1Adapter: RecyclerView.Adapter<En1Adapter.MyViewHolder>() {
    ...
    override fun onViewAttachedToWindow(holder: MyViewHolder) {
        ...
        holder.itemView.setOnClickListener {
            En1Fragment.click1Movie(moviesList[holder.adapterPosition])
        }
    }
