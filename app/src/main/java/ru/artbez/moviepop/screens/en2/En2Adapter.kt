...
import ru.artbez.moviepop.screens.en2.En2Fragment

class En2Adapter: RecyclerView.Adapter<En2Adapter.MyViewHolder>() {
    ...
    override fun onViewAttachedToWindow(holder: MyViewHolder) {
        ...
        holder.itemView.setOnClickListener {
            En2Fragment.click2Movie(moviesList[holder.adapterPosition])
        }
    }
