...
import ru.artbez.moviepop.screens.en3.En3Fragment

class En3Adapter: RecyclerView.Adapter<En3Adapter.MyViewHolder>() {
    ...
    override fun onViewAttachedToWindow(holder: MyViewHolder) {
        ...
        holder.itemView.setOnClickListener {
            En3Fragment.click3Movie(moviesList[holder.adapterPosition])
        }
    }
