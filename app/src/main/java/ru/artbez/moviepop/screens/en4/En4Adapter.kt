...
import ru.artbez.moviepop.screens.en4.En4Fragment

class En4Adapter: RecyclerView.Adapter<En4Adapter.MyViewHolder>() {
    ...
    override fun onViewAttachedToWindow(holder: MyViewHolder) {
        ...
        holder.itemView.setOnClickListener {
            En4Fragment.click4Movie(moviesList[holder.adapterPosition])
        }
    }
